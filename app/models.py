    ...
    def __init__(self, **kwargs):
        ...
        for key, val in kwargs.items():
            try:
                ...
                errors.append('* Field: \'{}\''.format(key))
        if errors:
            print('\nUnknown Field Error: Attempts to add values for the following fields failed, because they do not exist '
                  'in the database.' + '\nPlease verify the spelling of these field(s), and if no error is found please '
                  'check to ensure that they exist in the database.')
            for error in errors:
                print(error)

    def __repr__(self):
        # - Note: Using __dict__ alone seems to also not return python built-in class attributes.
